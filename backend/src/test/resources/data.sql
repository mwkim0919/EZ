...
INSERT INTO Category(id, category_limit, create_datetime, name, parent_category_id, user_id)
VALUES (4, 300.00, now(), 'Food', null, 1);

INSERT INTO Category(id, category_limit, create_datetime, name, parent_category_id, user_id)
VALUES (5, 250.00, now(), 'Pizza', 4, 1);

INSERT INTO Category(id, category_limit, create_datetime, name, parent_category_id, user_id)
VALUES (6, 50.00, now(), 'Coke', 4, 1);

INSERT INTO transaction(id, description, withdraw, deposit, transaction_datetime, create_datetime, user_id, category_id)
VALUES (1, 'My first expense', 100.00, null, now(), now(), 1, 1);

INSERT INTO transaction(id, description, withdraw, deposit, transaction_datetime, create_datetime, user_id, category_id)
VALUES (2, 'My second expense', 100.00, null, now(), now(), 1, 1);

INSERT INTO transaction(id, description, withdraw, deposit, transaction_datetime, create_datetime, user_id, category_id)
VALUES (3, 'My first expense', 100.00, null, now(), now(), 2, 1);
